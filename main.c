...
int main() {
  ...
  if (operator == '+') {
    ...
    printf("\tSum is: %d %c %d\n\t= %d\n",value1, operator, value2, result = Sum(value1, value2)); // if evaulated to true then the code block gets exetuted
  } else if (operator == '-') {

      printf("\tSubtraction is: %d %c %d\n\t= %d\n",value1, operator, value2, result = Subtract(value1, value2));
